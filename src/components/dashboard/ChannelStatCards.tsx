...
export function ChannelStatCards() {
  ...
  if (!channelId) {
    return (
      <div className="col-span-full flex items-center justify-center rounded-2xl border border-dashed border-slate-800 bg-slate-900/20 p-4 text-xs text-slate-500">
  ...
  if (error) {
    return (
      <div className="col-span-full flex items-center justify-center rounded-2xl border border-slate-800/60 bg-slate-900/40 p-4 text-xs text-slate-400">
