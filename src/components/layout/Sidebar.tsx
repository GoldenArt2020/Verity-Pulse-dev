...
export function Sidebar() {
    ...
    <>
      <div className="flex items-center gap-2.5 px-5 py-6">
        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-brand">
          <svg viewBox="0 0 24 24" className="h-4 w-4 text-brand-foreground" fill="currentColor">
      ...
      <div className="space-y-3 p-4">
        ...
        <div className="relative border-t border-sidebar-border pt-3">
          <button
            onClick={() => setMenuOpen((v) => !v)}
            className="flex w-full items-center gap-2.5 rounded-lg px-1 py-1 hover:bg-sidebar-accent"
          >
  ...
  return (
    <>
      <aside className="hidden h-screen w-[256px] shrink-0 flex-col border-r border-sidebar-border bg-sidebar md:flex">
        {content}
      </aside>
