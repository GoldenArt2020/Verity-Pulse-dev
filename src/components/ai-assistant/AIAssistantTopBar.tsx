...
export function AIAssistantTopBar() {
  return (
    <div className="flex items-center justify-between gap-4">
      <div>
        <h1 className="text-2xl font-bold text-white">AI Assistant Workspace</h1>
        <p className="text-sm text-slate-400">Your intelligent partner for research, analysis, content strategy and more.</p>
      </div>
      ...
      <div className="flex items-center gap-3">
        <div className="relative w-80">
          ...
          <input
            placeholder="Search cases, projects, files, insights..."
