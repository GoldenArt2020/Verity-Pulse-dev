...
- Redundant repetition of a fact purely for emotional weight (e.g. stating someone's age three separate times in different words without new context each time). Repeat a fact only when the repetition adds new meaning or context.
